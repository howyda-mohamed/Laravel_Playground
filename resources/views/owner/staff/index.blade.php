...
<div class="dashboard-ecommerce">
    <div class="container-fluid dashboard-content ">
        ...
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            <div class="card">
                <h5 class="card-header">Staff Center Table</h5>
                <div class="card-body">
                    <div class="table-responsive">
                        <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper dt-bootstrap4">
                            <div class="row">
                                <div class="col-sm-12 col-md-6">
                                    <a href="{{route('owner.staff.create')}}" class="btn btn-primary">Add Staff Center</a></td>
                                </div>
                            ...
                            <thead>
                                <tr role="row">
                                    ...
                                    <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Office: activate to sort column ascending" style="width: 130.325px;">job</th>
                            ...
                            <tbody>
                                ...
                                <tr role="row" class="odd">
                                    ...
                                    <td>{{$staff->name}}</td>
                                    <td>{{$staff->job}}</td>
                                    <td ><img src="{{asset($staff->image)}}" width="100px" height="100px"/></td>
                                    <td><a href="{{route('owner.staff.edit',$staff->id)}}" class="btn btn-info">Edit</a></td>
                                    <td><a href="{{route('owner.staff.delete',$staff->id)}}" class="btn btn-danger">Delete</a></td>
                                </tr>
                                @endforeach
                            </tbody>
                        </table>
