                        ...
                        <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper dt-bootstrap4">
                            <div class="row">
                                <div class="col-sm-12 col-md-6">
                                    <a href="{{route('owner.playground.create')}}" class="btn btn-primary">Add Playground</a></td>
                                </div>
                            ...
                            <tbody>
                                ...
                                <tr role="row" class="odd">
                                    ...
                                    <td><a href="{{route('owner.playground.edit',$play->id)}}" class="btn btn-info">Edit</a></td>
                                    <td><a href="{{route('owner.playground.delete',$play->id)}}" class="btn btn-danger">Delete</a></td>
                                </tr>
                                @endforeach
                            </tbody>
