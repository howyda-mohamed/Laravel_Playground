                        ...
                        <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper dt-bootstrap4">
                            <div class="row">
                                <div class="col-sm-12 col-md-6">
                                    <a href="{{route('admin.setting.create')}}" class="btn btn-primary">Add Setting Center</a></td>
                                </div>
                            ...
                            <tbody>
                                ...
                                <tr role="row" class="odd">
                                    ...
                                    <td >{{ $setting->email }}</td>
                                    <td>{{$setting->phone}}</td>
                                    <td><a href="{{route('admin.setting.edit',$setting->id)}}" class="btn btn-info">Edit</a></td>
                                    <td><a href="{{route('admin.setting.delete',$setting->id)}}" class="btn btn-danger">Delete</a></td>
                                </tr>
                                @endforeach
                            </tbody>
                        </table>
